...
export class JitterBuffer {
  ...
  private droppedCallback: any;
  private totalLengthMs: number;
  private numTotalGaps: number;
  private numTotalLostStreams: number;
  private lastCorrectSeqId: number | undefined;
  private lastSeqIdDelivered: number | undefined;
